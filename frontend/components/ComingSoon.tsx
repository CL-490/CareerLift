...
export function ComingSoon({ title, blurb = "This feature is under active development.", backHref = "/" }: ComingSoonProps) {
  return (
    <div className="max-w-3xl mx-auto pt-4">
      <h1 className="text-[40px] font-semibold tracking-tight bg-gradient-to-r from-white via-[#d9fef5] to-[#6bf6ff] bg-clip-text text-transparent mb-6">
        {title}
      </h1>
      <div className="card hover-ring mb-10">
        <div className="flex flex-col gap-5">
          <p className="text-[#9aa5b3] text-[15px] leading-relaxed">
            {blurb}
          </p>
          <div className="rounded-md border border-dashed border-[rgba(255,255,255,0.14)] p-6 text-sm text-[#7e8a98] bg-[#121c27]/40">
          ...
          <div className="flex items-center gap-4 pt-2">
            ...
            <span className="text-[11px] tracking-wider uppercase text-[#556273]">Placeholder</span>
          </div>
        </div>
      </div>
    </div>
